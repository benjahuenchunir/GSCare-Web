...
const ConfirmActionModal: React.FC<ConfirmActionModalProps> = ({ open, onClose, onConfirm, message }) => {
  if (!open) return null;
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-xl shadow-lg w-[90%] max-w-sm p-6 relative">
        ...
        <h2 className="text-[1.2em] font-semibold text-[#009982] mb-2">¿Está seguro?</h2>
        <p className="text-[1em] text-gray-600 mb-6">{message || '¿Desea confirmar esta acción?'}</p>
