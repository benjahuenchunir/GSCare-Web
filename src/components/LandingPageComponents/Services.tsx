...
export default function Services() {
  return (
    <section id="services" className="w-full bg-white text-gray-600 font-[Poppins] py-16 px-6">
      <h2 className="text-center text-3xl sm:text-4xl md:text-5xl font-bold text-[#006881] mb-12">
        Nuestros servicios
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 max-w-screen-lg mx-auto">
        ...
        <div className="bg-gray-200 p-6 flex flex-col justify-between rounded-lg">
          <div className="flex items-start mb-4">
            <h3 className="flex-1 text-2xl sm:text-3xl font-bold text-[#006881]">
          ...
          <div className="text-right">
            <a href="#" className="px-4 py-2 text-lg border-2 border-[#006881] text-[#006881] rounded-lg hover:bg-[#006881] hover:text-white transition">
              Saber más
            </a>
          </div>
        </div>
