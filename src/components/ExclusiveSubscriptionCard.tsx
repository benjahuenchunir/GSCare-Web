...
const ExclusiveSubscriptionCard = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-[#E0F8F4] via-[#F5FFFB] to-[#F0FFF9] rounded-2xl border border-[#B0E3DB] shadow-xl hover:shadow-2xl transition-all duration-300 p-8  ">
      ...
      {/* Premium badge */}
      <div className="absolute top-4 right-4 bg-[#009982] text-white px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start gap-4 mb-6">
          <div className="p-3 bg-[#009982] rounded-2xl shadow-lg">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button
            ...
            className="group bg-[#009982] hover:from-[#007F6F] hover:to-[#36A2A1] text-white font-semibold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2 min-w-fit"
          >
